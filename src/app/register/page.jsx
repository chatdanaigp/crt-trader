        ...
        <main className="min-h-screen relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto px-4 py-12 sm:py-20">
                ...
                >
                    ...
                    <span>กลับไปหน้าเลือกกลุ่ม</span>
                </Link>
                ...
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
                        <span className="primary-gradient">ลงทะเบียนสมาชิก VIP</span>
                    </h1>
                    <p className="text-text-secondary text-lg">
                        เข้าร่วม Discord Master Signal Community
                    </p>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="กรอก Connext Client ID"
